...
3日目の午前中はトークセッションはなく、ポスターセッションとジョブフェア、コミュニティショーケースのみとなります。
...
Pythonの拡張提案であるPEPの受諾または拒否の決定をし、Pythonの品質と安定性を維持しています。
また、PSFと協力してプロジェクトの資産を管理しています。
...
予約した時間まで少し余裕があったので、私を含むビールクズ数名で[Penn Brewery](https://www.pennbrew.com/)に行きました。
